...
public class TreeMain {
	...
	// will need to implement comparable interface in StudentKey or else it will throw ClaaCastException
	private static Map<StudentKey, Student> studentTreeMap = new TreeMap<>();
	...
	static void addStudent() {
		...
		studentTreeMap.put(key, student);
...
//		which would throw a NullPointerException in containsKey()
		Student student = key != null  ? studentTreeMap.get(key) : null;
	...
	private static void printStudents() {
		if (studentTreeMap.isEmpty()) {
			...
			for (Map.Entry<StudentKey, Student> entry : studentTreeMap.entrySet()) {
				System.out.println(""
//						entry.getKey() 
//						+ ": " 
						+ entry.getValue());
